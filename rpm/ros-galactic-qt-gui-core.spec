...
Requires:       ros-galactic-qt-dotgraph >= 0.3.0
Requires:       ros-galactic-qt-gui >= 0.3.0
Requires:       ros-galactic-qt-gui-app >= 0.3.0
Requires:       ros-galactic-qt-gui-cpp >= 0.3.0
Requires:       ros-galactic-qt-gui-py-common >= 0.3.0
