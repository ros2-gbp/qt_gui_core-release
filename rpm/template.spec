...
Requires:       ros-galactic-pluginlib >= 1.9.23
...
BuildRequires:  ros-galactic-pluginlib >= 1.9.23
BuildRequires:  ros-galactic-python-qt-binding >= 0.3.0
